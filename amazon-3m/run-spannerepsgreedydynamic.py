...
def flass(seed):
    ...
    print(f'train(mydata, model=model, actions=embeds, initlr={banditinitlr}, tzero={bandittzero}, epsilon={epsilon}, epsilontzero={epsilontzero}, batch_size={banditbs}, pretrain={pretrain}, cuda={cuda}, seed={2*seed+1})')
    train(mydata, model=model, actions=embeds,
          initlr=banditinitlr, tzero=bandittzero,
          epsilon=epsilon, epsilontzero=epsilontzero,
          batch_size=banditbs, pretrain=pretrain,
          cuda=cuda, seed=2*seed+1)
