...
def flass():
    ...
    seed, rank, prebs, banditbs, cuda = 4545, 800, 32, 256, True
    ...
    print('train')
    for (banditinitlr, bandittzero,
         epsilon, epsilontzero) in ( (1/2560 + 1/640 * random.random(),     # banditinitlr
            ...
            print(f'train(mydata, model=model, actions=embeds, initlr={banditinitlr}, tzero={bandittzero}, epsilon={epsilon}, epsilontzero={epsilontzero}, batch_size={banditbs}, pretrain={pretrain}, cuda={cuda}, seed={seed})')
            train(mydata, model=deepcopy(model).cuda(), actions=embeds, 
